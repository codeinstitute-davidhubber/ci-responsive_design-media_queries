### Code Institiute - Responsive Design - Media Queries
...
description: **It is a CSS rule. It applies styles to a particular screen, device or environment. The most common way to use media queries is to specify at least one breakpoint.**
